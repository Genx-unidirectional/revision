...
function getFirstElem(arr: number[], num: number) {
...
function getLastElem(arr: number[], num: number) {
...
function checkElem(arr: number[], num: number) {
...
function deleteAllOccurrences(arr: number[], num: number) {
...
function deleteAllOccurrences2(arr: number[], num: number) {
  let newArr = [];
...
function filteredArrWithNum(arr: number[], num: number) {
  let newArr: number[] = [];
  for (let i = 0; i < arr.length; i++) {
    if (arr[i] > num) {
      newArr.push(arr[i]);
...
function averageOfAllNum(arr: number[]) {
...
function sumSquareAvg(arr: number[]) {
...
function arrElemChanger(arr: number[], factor: number) {
...
function uppercaseArray(arr: string[]) {
...
function doubleExtraArgs(arr: number[], ...args: number[]) {
